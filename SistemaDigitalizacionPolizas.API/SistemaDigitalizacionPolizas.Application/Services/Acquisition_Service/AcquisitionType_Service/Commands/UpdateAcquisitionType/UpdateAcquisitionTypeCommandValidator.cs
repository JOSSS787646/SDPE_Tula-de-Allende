...
{
    public class UpdateAcquisitionTypeCommandValidator
       : AbstractValidator<UpdateAcquisitionTypeCommand>
    {
        public UpdateAcquisitionTypeCommandValidator()
        {
            RuleFor(x => x.idUpdateAcquisitionType)
                .GreaterThan(0)
